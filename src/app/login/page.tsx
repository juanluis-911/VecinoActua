      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl p-8 border border-slate-100 dark:border-slate-800">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 text-center mb-6">
            Haz escuchar tu colonia
          </p>

          {magicSent ? (
            <div className="text-center py-4">
              <div className="text-4xl mb-3">📬</div>
              <p className="font-semibold text-slate-800 dark:text-white">¡Revisa tu correo!</p>
            ...
            <>
              ...
              <form onSubmit={handleEmailLogin} className="space-y-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 bg-[#2D9CDB] hover:bg-[#2589c5] text-white font-semibold rounded-xl transition-colors disabled:opacity-50"
                >
              ...
              <button
                ...
                disabled={loading}
                className="w-full mt-2 py-2.5 text-sm text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"
              >
        ...
        <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-4">
          ¿No tienes cuenta?{" "}
          <Link href="/registro" className="text-[#2D9CDB] font-medium hover:underline">
            Regístrate gratis
          </Link>
        </p>
      </div>
